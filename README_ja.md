...
**Azazel-Zero** は、Raspberry Pi Zero 2 W 上で動作する **「身代わりファイアウォール」** のプロトタイプです。

このシステムは、**Azazel System の「遅延防御」コンセプトを現実的に実装する** ことを目的としています。  
同時に、Azazel System の原点である **「身代わりファイアウォール」** および **「ファイアウォール迷路」** というアイデアに立ち返っています。

### Azazel-Pi との比較

- **Azazel-Pi**  
  - Raspberry Pi 5 をベースにした **ポータブル・セキュリティゲートウェイ（サイバー身代わりゲートウェイ）**  
